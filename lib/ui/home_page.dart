...
class _HomePageState extends State<HomePage> {
 ...
 static String API_KEY = '43a70ca3167e409d837131832222312'; // Je sais c'est pas bien de mettre la clé ici mais je n'ai pas trouvé d'autre solution pour l'instant

  String location = 'Brest'; //Default location
  ...
  void fetchWeatherData(String searchText) async {
    try {
      ...
      final weatherData = Map<String, dynamic>.from(
          json.decode(searchResult.body) ?? 'Pas de données');
                                            ...
                                            children: [
                                              ...
                                              TextField(
                                                ...
                                                decoration: InputDecoration(
                                                    ...
                                                    hintText:
                                                        'Rechercher un ville, Brest par exemple',
                                                    focusedBorder:
                                                        OutlineInputBorder(
